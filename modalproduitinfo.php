<div class="modal fade" id="modalinfoprd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div data-v-33681578="" data-v-561bb412="">
                    ...
                    <footer data-v-33681578="" class="modal-footer fixed">
                        ...
                        <button data-v-33681578="" type="button"
                                class="btn btn btn-default btn-primary btn-secondary" onclick="prdf()"  aria-label="Close">Enregistrer
                        </button>
                    </footer>
                </div>
            </div>

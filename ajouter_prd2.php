                        ...
                        <div data-v-77800238="" class="card">
                            <!----><!----><div data-v-77800238="" class="card-body"><!----><!---->
                                <div  class="row">
									...
									<div class="col-md-4 col-lg-4 col-4 col-sm-4" style="text-align:center ;margin-bottom: 32px"><!---->
                            <button data-v-77800238="" style="border: 1px solid;" type="submit" name="cree" class="btn btn-default">Créer</button>
                                ...
                                <div data-v-2c453691="" class="_w_parameters_containers mb-5"><div data-v-2c453691="" class="_w_parameters_content mb-3"><div data-v-2c453691="" class="tabs beautiful-tabs" fill="" id="__BVID__204"><!----><div class=""><ul role="tablist" class="nav nav-tabs" id="__BVID__204__BV_tab_controls_"><li role="presentation" class="nav-item"><a role="tab" id="__BVID__205___BV_tab_button__" aria-selected="true" aria-setsize="1" aria-posinset="1" target="_self" href="#" class="nav-link active">Fiche produit</a></li></ul></div><div class="tab-content mt-5" id="__BVID__204__BV_tab_container_"><div data-v-2c453691="" role="tabpanel" aria-hidden="false" aria-expanded="true" class="tab-pane tab show fade active" id="__BVID__205" tabindex="0" aria-labelledby="__BVID__205___BV_tab_button__" style=""><div data-v-2c453691="" class="row"><div data-v-2c453691="" class="col-lg-5"><fieldset data-v-2c453691="" class="form-group" id="__BVID__207" aria-labelledby="__BVID__207__BV_label_"><legend tabindex="-1" class="col-form-label pt-0" id="__BVID__207__BV_label_">Image principale</legend><div tabindex="-1" role="group" aria-labelledby="__BVID__207__BV_label_"><div data-v-eb086870="" data-v-2c453691="" class="d-flex"><input data-v-eb086870="" type="file" accept="image/*" name="product-images" class="d-none"> <div data-v-eb086870="" class="product-images-first-col alone"><div data-v-eb086870="" class="container-product-image empty first"><div data-v-eb086870="" class="ipt-f-box-empty">
        +
                   </div></div></div> <!----></div><!----><!----><!----></div></fieldset></div> <div data-v-2c453691="" class="col-lg-5"><div data-v-2c453691="" role="group" class="form-group" id="__BVID__209" aria-labelledby="__BVID__209__BV_label_" aria-describedby="__BVID__209__BV_description_">
				   <label for="productReference" class="d-block" id="__BVID__209__BV_label_">Référence</label><div>
				   <input data-v-2c453691="" id="productReference" type="text" placeholder="" class="form-control" autofocus="autofocus" aria-describedby="__BVID__209__BV_description_ __BVID__209__BV_description_"><!----><!----><small tabindex="-1" class="form-text text-muted" id="__BVID__209__BV_description_">Numero unique du produit</small></div></div> <div data-v-2c453691="" role="group" class="form-group" id="__BVID__211" aria-labelledby="__BVID__211__BV_label_">
				   <label for="productName" class="d-block" id="__BVID__211__BV_label_">Nom</label><div>
				   <input data-v-2c453691="" id="productName" type="text" placeholder="" class="form-control"><!----><!----><!----></div></div> 
...
<!--                                                                    </select>-->
                                                    ...
                                                    <div data-v-77800238="" role="group" class="form-group" id="__BVID__150" aria-labelledby="__BVID__150__BV_label_" aria-describedby="__BVID__150__BV_description_">
                                                        ...
                                                        <textarea class="form-control" name="desc" id="desc" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 100px;" ></textarea>
                                                    </div>
                                                </div>
...
<!--                                                    <div data-v-77800238="" class="col-sm-4 col-12" >-->
											...
											<div data-v-2c453691="" class="col-lg-3"> 

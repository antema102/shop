...
$columns = array(
    ...
    array('db' => 'id', 'dt' => 5, 'formatter' => function($d, $row) {
            ...
            if ($fac['etat'] == 2) {
                return '<i class="fas fa-circle" style="color:#9A3135 ;margin-right:12px;cursor: pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal2_' . $d . '"></i>
               <div class="modal fade" id="exampleModal2_' . $d . '" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">

...
if(isset($_GET['tvaLiv'])) {
    $tvaLiv = $_GET['tvaLiv'];
    $_SESSION['tvaLiv'] = ((float)$tvaLiv*(float)$fraisLiv)/100;
}
...
$_SESSION['prixht1'] = str_replace("€","",$_SESSION['prix_ttc']);
$_SESSION['prixttc1'] = $_SESSION['prix_ttc']*((100-$_SESSION['tva'])/100);
//$pttc = $ht - ($ht * $tva/100);
...
<table data-v-248579a2="">
    ...
    <tr data-v-248579a2="" >
        ...
        <td data-v-248579a2="" role="total_ttc" class="r-number" id="prixttct">
            <?php
            $ponte =  (float)$_SESSION['prix_ttc']+ (float)$_SESSION['fraisLiv'] + (float)$_SESSION['tvaLiv'];
            if ($ponte > 0) {
                $ponte =(float)$_SESSION['prix_ttc']+ (float)$_SESSION['fraisLiv'] + (float)$_SESSION['tvaLiv'] ;
              echo  $ponte=number_format($ponte,2);
            } else {
                $ponte =(float)$_SESSION['prix_ttc']+ (float)$_SESSION['fraisLiv'] + (float)$_SESSION['tvaLiv'] ;
              echo  $ponte=number_format($ponte,2);
            }
            ...
            ?> €</td>
        <input type="hidden" name="mtttc" value="<?php echo (float)$_SESSION['prix_ttc']+ (float)$_SESSION['fraisLiv'] + (float)$_SESSION['tvaLiv']?>">
    </tr>
...
<?php if(isset($_SESSION['prix_ht_avoir']) && ($_SESSION['prix_ht_avoir'] != '')) {
    $_SESSION['prix_httc_avoir'] = is_numeric($_SESSION['prix_ttc']) - is_numeric($_SESSION['prix_ht_avoir']);
    ?>
    <table data-v-248579a2="" style="margin-top:10px">
        <body data-v-248579a2="">
        <tr data-v-248579a2=""vstyle="background-color: #32baa8; color: rgb(255, 255, 255);">
        ...
        <tr data-v-248579a2="">
            ...
            <td data-v-248579a2="" role="totalHT" class="r-number" id="prixhtt" onchange="calculPrixHT()">
                ...
                echo $_SESSION['prix_httc_avoir'], 2, ".", " ";
            ...
            <div data-v-77800238="" role="group" class="form-group" id="__BVID__1551" onchange="calculPrixtest3()" aria-labelledby="__BVID__1551">
                ...
                <div>
                    <select data-v-77800238="" class="custom-select" name="tva2" id="__BVID__1521">
                        <option data-v-77800238="" value="0">0</option>
                        <option data-v-77800238="" value="5">5</option>
						<option data-v-77800238="" value="7">7</option>
                        <option data-v-77800238="" value="10">10</option>
                        <option data-v-77800238="" value="20">20</option>
                    </select>

...
<html lang="fr" > 
    ...
    <body lang="fr">
        <div class="LayoutShell">
            ...
            <main class="main">
                <form method="post" action="save_dev.php">
                    <div data-v-561bb412="" class="main-quote">
                        ...
                        <div data-v-561bb412="" style="height: auto;" size="A4" data-id="1" class="page narrow top-shadow bottom-shadow">
                                    ...
                                    <div data-v-561bb412="">
                                        <div data-v-561bb412="" class="quote-name inline-block">
                                            <span data-v-561bb412=""  >
                                                ...
                                                <input data-v-561bb412="" class="editable" type="text" name="numdev" id="numdev" value="<?php echo $maximum ?>" style="border: none;" >  <br>

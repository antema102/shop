...
<html lang="fr">
                ...
                <div data-v-9af19398="" id="content-wrapper" class="container-xxl">
                    <div data-v-9af19398="" class="row row_header mb-4">
                        <div data-v-9af19398="" class="col-xl-3 col-md-6 "><h1 data-v-9af19398="" class="title header-form">
                                Liste des Proforma</h1>
                        </div>
                        <div data-v-9af19398="" class="col-xl-6 col-md-6 d-flex justify-content-center">
                            <input data-v-9af19398="" type="text"  placeholder="Rechercher une facture"  class="inline search form-control form-control" id="">
                            ...
                            <div data-v-6a7eb354="" class="col-md-8 d-flex justify-content-end">
                                <div data-v-5232cd18="" data-v-9af19398="" class="actions sub-menu quote">
                                    <div data-v-5232cd18="" class="dropdown-item">
                                        <a data-v-5232cd18="" href="addfactures.php" class="w_actions_button has-tooltip" data-original-title="null">
                                            <i data-v-5232cd18="" style="color:#ffffff;" class="icon ion-ios-add"></i>
                                            <span data-v-5232cd18="" style="color:#ffffff;">Créer une Proforma</span></a>
                                    </div>
    ...
    color: #28B5BF;font-weight :600" >
                            ...
                            <div data-v-9af19398="" class="card table-wrap mb-3" >
                                <div id="et">
                                    <table data-v-9af19398="" role="table" aria-busy="false" aria-colcount="8" class="table b-table fixed-table responsive-table mb-0 table-hover b-table-stacked-md" id="__BVID__92">
                                        ...
                                        <th tabindex="0" scope="col" aria-colindex="7" aria-label="Click to sort Descending" aria-sort="none" class="" style="width:200px !important;">Total HT</th>
        ...
        <script>
            ript src="https://code.jquery.com/jquery-3.5.0.min.js"
...
<script>
                                    function etat(etat, id) {
                                        $.ajax({
                                            type: "POST",
                                            url: "edit_status_es.php?etat=" + etat + "&id=" + id,
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                loTable = $('#__BVID__92').DataTable({
                    ...
                    "processing": false,
                    "serverSide": true,
                    "ajax": "<?php echo url ?>dateRangeFs.php?start_date="+start_date+"&end_date="+end_date+"",
                    "dom": 'Bfrtip',
                    "order": [[1, "asc"]], //or asc,
                    buttons: [
                        {
            ...
            $(document).ready(function () {
                ...
                oTable = $('#__BVID__92e0').DataTable({
                    ...
                    "processing": false,
                    "serverSide": true,
                    "ajax": "<?php echo url ?>findefse0.php",
                    "dom": 'Bfrtip',
                    "order": [[1, "asc"]], //or asc,
                    buttons: [
                        {
            ...
            $(document).ready(function () {
                ...
                oTable = $('#__BVID__92e1').DataTable({
                    ...
                    "processing": false,
                    "serverSide": true,
                    "ajax": "<?php echo url ?>findefse1.php",
                    "dom": 'Bfrtip',
                    "order": [[1, "asc"]], //or asc,
                    buttons: [
                        {
            ...
            $(document).ready(function () {
                ...
                oTable = $('#__BVID__92e2').DataTable({
                    ...
                    "processing": false,
                    "serverSide": true,
                    "ajax": "<?php echo url ?>findefse2.php",
                    "dom": 'Bfrtip',
                    "order": [[1, "asc"]], //or asc,
                    buttons: [
                        {
            ...
            $(document).ready(function () {
                ...
                oTable = $('#__BVID__92e3').DataTable({
                    ...
                    "processing": false,
                    "serverSide": true,
                    "ajax": "<?php echo url ?>findefse3.php",
                    "dom": 'Bfrtip',
                    "order": [[1, "asc"]], //or asc,
                    buttons: [
                        {
            ...
            $(document).ready(function () {
                ...
                oTable = $('#__BVID__92e4').DataTable({
                    ...
                    "processing": false,
                    "serverSide": true,
                    "ajax": "<?php echo url ?>findefse4.php",
                    "dom": 'Bfrtip',
                    "order": [[1, "asc"]], //or asc,
                    buttons: [
                        {

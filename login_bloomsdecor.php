            ...
            <div class="row cover-full">
                <div class="LayoutDefault__panel col-lg-4 left">
                    <div class="inner-content"><img src="" alt="" class="logo-home">
                        ...
                        <h1 class="header-text"><span class="wuro-highlight" style="color: #C3CC57 ;">Shop</span> 
						<span class="wuro-highlight"   style="color: #205459 ;"> Blooms Décor</span></h1>
                ...
                <main class="LayoutDefault__main col-lg-8 col-sm-12 right">
                    <div data-v-1f29256e="" class="card-form">
                        ...
                        <form data-v-1f29256e="" method="post">
                            ...
                            <div data-v-1f29256e="" style="margin-bottom: 30px;" class="form-group relative ">
                            ...
                            <button data-v-1f29256e="" aria-label="connection" style="display: block;margin: auto;" name="conn" type="submit" class="btn btn-block btn-primary margin-t-2x mg-center-phone">
                                Connexion
                            </button> 
                        </form> 
                        <p data-v-1f29256e="" style="text-align: center;margin-top: 15px;" class="margin-t-2x c_t_phone">

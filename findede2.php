...
$columns = array(
    ...
    array('db' => 'id', 'dt' => 5, 'formatter' => function($d, $row) {
            ...
            if ($fac['etat'] == 2) {
                return '<i class="fas fa-circle" style="color:#009393 ;margin-right:12px;cursor: pointer;"data-bs-toggle="modal" data-bs-target="#notif2"></i>  <div class="modal fade" id="notif2"tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
echo json_encode(
        SSP::complex22($_GET, $sql_details, $table, $primaryKey, $columns, null, "etat = '2'")
);
?>
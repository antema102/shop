            ...
            <main class="main">
                <div class="params-component" data-v-50f926f1="">
                    <div class="_w_parameters_containers invite-user">
                        <h2 class="_w_parameters_headers">Serveur SMTP</h2> 
                            ...
                            if(isset($_POST['cree']))
                                {
                                    ...
                                    $email=$_POST['email_emetteur'];
                                    $nom=$_POST['nom'];

                                    $fileconfig=fopen("config.inc.php", "w+");
                                    $configtxt="<?php return array(
                                ...
                                <div class="col-lg-6">
                                    <form method="post">
                                        <div class="form-group">
                                            ...
                                            <label for="inputCompanyName">Host:</label>
                                            <input required = "required" type = "text" placeholder = "smtp.exemple.com" id = "inputEmailUserInvite" value="<?=$host?>" name = "host" class = "form-control">
                                            <br>
                                             <label for="inputCompanyName">Utilisateur:</label>
                                            <input required = "required" type = "text" placeholder = "contact@exemple.com" value="<?=$user?>" id = "inputEmailUserInvite" name = "user" class = "form-control">
                                            <br>
                                             <label for="inputCompanyName">Mot de passe:</label>
                                            <input required = "required" type = "password" placeholder = "" id = "inputEmailUserInvite" value="<?=$password?>" name = "password" class = "form-control">
                                             <br>
                                             <label for="inputCompanyName">Port:</label>
                                            <input required = "required" value="<?=$port?>" type = "text" placeholder = "Exemple : 25" id = "inputEmailUserInvite" name = "port" class = "form-control">
                                            <br>
                                             <label for="inputCompanyName">Email d'envoi:</label>
                                            <input required = "required" value="<?=$email?>" type = "email" placeholder = "contact@exemple.com" id = "inputEmailUserInvite" name = "email_emetteur" class = "form-control">
                                            <br>
                                             <label for="inputCompanyName">Nom de l'émetteur:</label>
                                            <input required = "required" value="<?=$nom?>" type = "text" placeholder = "E-mail de l'utilisateur" id = "inputEmailUserInvite" name = "nom" class = "form-control">
                                           

                                            <div class = "col-md-12 col-12 col-sm-12 col-lg-12" style = "text-align:center ;margin-bottom: 32px;margin-top: 32px" ><!---->
                                                <button data-v-77800238 = "" style = "border: 1px solid;" type = "submit" name = "cree" class = "btn btn-default">Enregistrer</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>

<div class="modal fade" id="modalinfavoir" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div role="document" class="modal-content" id="__BVID__41___BV_modal_content_" aria-labelledby="__BVID__41___BV_modal_header_" aria-describedby="__BVID__41___BV_modal_body_">
            <header class="modal-header" id="__BVID__41___BV_modal_header_">
                <h5 class="modal-title"> Ajouter un avoir </h5>
            ...
            <div class="modal-body" id="__BVID__41___BV_modal_body_">
                <div data-v-33681578="" data-v-561bb412="">
                    <div data-v-33681578="" >
                        <div data-v-33681578="" >
                            <input data-v-33681578=""  type="text" placeholder="Avoir" id="clientavoir" class="form-control" >
                        </div>
                    ...
                    <footer data-v-33681578="" class="modal-footer fixed">
                        ...
                        <button data-v-33681578="" type="button"
                                class="btn btn btn-default btn-primary btn-secondary" onclick="avoirClient()" aria-label="Close">Enregistrer
                        </button>
                    </footer>
                </div>
            </div>

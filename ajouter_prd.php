...
$codeabarre = mysqli_fetch_array(mysqli_query($link, "SELECT max(id) as max_id FROM `produit`"));
$codeabarre=$codeabarre['max_id']+1;
?>
<html lang="fr" > 
    <head>
        <meta charset="utf-8">
...
<!--                                                                    </select>-->
                                                        ...
                                                        <fieldset data-v-77800238="" class="form-group" id="__BVID__144" aria-labelledby="__BVID__144__BV_label_" aria-describedby="__BVID__144__BV_description_">
                                                          ...
                                                          <!--  <legend tabindex="-1" class="col-form-label pt-0" id="__BVID__144__BV_label_">Code-barres</legend>
                                                            ...
                                                            <legend tabindex="-1" class="col-form-label pt-0" id="__BVID__144__BV_label_">Code-barres</legend>
                                                            <div tabindex="-1" role="group" aria-labelledby="__BVID__144__BV_label_">
                                                                <input data-v-77800238="" name="code_a_barre" type="text" placeholder="Code-barres" class="form-control" id="__BVID__145" value="<?php echo sprintf("%08d",$codeabarre);?>" readonly>
                                                                <input style="display: none" type="submit" name="code"  class="btn btn-success text-center form-controll" id="" value="Generate Barcode">
                                                                <?php           
                                                                    if(isset($_POST['code'])) {
                                                                    $code_a_barre = trim($_POST['code_a_barre']);
                                                                    if($code_a_barre != '') {
                                                                        echo '<h6>Generated Barcode</h6>';
                                                                        echo "<center><img alt='testing' src='barcode.php?codetype=code39&size=50&text=".$code_a_barre."&print=true'/></center>";  
                                                                    } else {

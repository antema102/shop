...
for ($i = 0; $i < sizeof($_SESSION['cart']); $i++) {
    ...
    if($id_cart == $productId) {
        $prix_ht_cart = - $_SESSION['cart'][$i]['prix_ht'];
        $prix_ttc_cart = - $_SESSION['cart'][$i]['prix_ttc'];
    } else {
        $prix_ht_cart = $_SESSION['cart'][$i]['prix_ht'];
        $prix_ttc_cart = $_SESSION['cart'][$i]['prix_ttc'];    
    }
...
$_SESSION['prix_ht'] = $_SESSION['prix_ht'] + $prix_ht_cart;
$_SESSION['prix_ttc'] = $_SESSION['prix_ttc'] + $prix_ttc_cart;

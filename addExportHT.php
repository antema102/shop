...
if ($max['nb'] == 0) {
    ...
    if (($maximum < 10)) {
        $maximum = "ES00000" . $maximum;
    }
    if (($maximum < 100) && ($maximum >= 10)) {
        $maximum = "ESC0000" . $maximum;
    }
    if (($maximum < 1000) && ($maximum >= 100)) {
        $maximum = "ESC000" . $maximum;
    }
    if (($maximum < 10000) && ($maximum >= 1000)) {
        $maximum = "ES00" . $maximum;
    }
    ...
    <body lang="fr">
        <div class="LayoutShell">
            ...
            <main class="main">
                ...
                <form method="post" action="save_espace_ht.php" >
...
<!--                                    <button onClick="imprimer('sectionAimprimer')">Imprimer</button>-->
                                    <input type="button" id="btnPrint" value="Imprimer" style=" border:1px solid #3D7DA0;color:#3D7DA0;background: #FFFFFF"  class="btn btn btn-default btn-primary btn-secondary" />
...
<!--                                    <button data-v-561bb412="" value="Sauvegarder" name="action" type="submit" style=" border:1px solid #3D7DA0;color:#3D7DA0;background: #FFFFFF"  class="btn btn btn-default btn-primary btn-secondary">-->
<!--                                        Sauvegarder-->
<!--                                    </button>-->
<!--                                    <button data-v-561bb412="" value="Imprimer" name="action" type="submit"  style=" border:1px solid #3D7DA0;color:#3D7DA0;background: #FFFFFF"  class="btn btn btn-default btn-primary btn-secondary">-->
<!--                                        Imprimer-->
<!--                                    </button>-->
                                </div>
                            </div>
                        </div>
                        <div data-v-561bb412="" size="A4" style="height: auto;" data-id="1" class="page narrow top-shadow bottom-shadow"  id="dvContents">

                            <div data-v-561bb412="" class="content">
                                <div data-v-561bb412="" class="quote-header">
                                    <div data-v-561bb412="" >
                                        <!-- <div id="logo" data-v-561bb412="" class="logo-wrapper" style="height: 100px; margin: 20px;"> -->
                                        <div id="logo" data-v-561bb412="" class="logo-wrapper logoStyle">
                                            <img data-v-561bb412="" loading="lazy" src="<?php echo url ?>img/Untitled-1.png" alt="" class="logo">
                                        </div>
                                    </div>
                                    ...
                                    <div data-v-561bb412="">
                                        <div data-v-561bb412="" class="quote-name inline-block">
                                            <span data-v-561bb412=""  >
                                                Numéro de Facture HT : <br>
                                                <input  type="hidden" name="numdev" id="numdev" value="<?php echo $maximum ?>" >
                                                <input  type="text" disabled  value="<?php echo $maximum ?>" style="border: none;" >  <br>
                                    ...
                                    <div data-v-561bb412="">
                                        <div data-v-561bb412="" class="row address-informations">
                                            <div data-v-561bb412="" class="company-infos col">
                                                ...
                                                <div data-v-561bb412="" class="company-name">BLOOMS DECOR</div>
                                                <div data-v-561bb412="" class="company-phone">BLOOMS DECOR, 209 Avenue de</div>
                                ...
                                <div data-v-561bb412="" class="quote-lines" id="cnt">
                                    <div data-v-561bb412="" class="watermark">Proforma</div>
                                    <table data-v-561bb412="" class="quote-lines-table">
                                        <thead data-v-561bb412="" class="quote-lines-header">
                                            <tr data-v-561bb412="" style="background-color: #BBC641 ; color: rgb(255, 255, 255);">
                                                ...
                                                <th data-v-561bb412="" class="text--right text--nowrap" style="display: inline-table ; display: none;">
                                ...
                                <div data-v-561bb412="">
                                    <div data-v-248579a2="" data-v-561bb412="" class="document-summary-full">
                                        ...
                                        <div data-v-248579a2="" class="document_summary" id="calculExportHT">
                                            <table data-v-248579a2="">
                                                <tbody data-v-248579a2="">
                                                    <tr data-v-248579a2="" style="background-color: #205459; color: rgb(255, 255, 255);">
                                                    ...
                                                    <tr data-v-248579a2="" style="display: inline-table ; display: none;" >
                                                        <td data-v-248579a2="">Montant total TVA</td>
                                                        <td data-v-248579a2="" role="totalTVA" class="r-number">0,00&nbsp;€</td>
                                                    </tr>
                                                    <tr data-v-248579a2="" class="total" style="display: inline-table ; display: none;">
                                ...
                                <div data-v-dc3a3862="" data-v-561bb412="" class="company-footer"
                                    ...
                                    <span data-v-dc3a3862="" class="align-center"> BLOOMS DECOR - BLOOMS DECOR, 209 Avenue de la république 93800 Epinay sur seine France <br></span>
        ...
        <script>
            ...
            function livinfo() {
                ...
                $.ajax({
                        type: "POST",
                        url: "calculExportHT.php?fraisLiv=" + frl + "&tvaLiv=" + tvaLiv,
                        success: function (data) {
                            document.getElementById("calculExportHT").innerHTML = data;
                        }
                    });
            }
        ...
        /*    function clientf() {
            ...
            function calculExportHT() {
                $.ajax({
                    type: "POST",
                    url: "calculExportHT.php",
                    success: function (data) {
                        document.getElementById("calculExportHT").innerHTML = data;
                    }
                });
            ...
            function calculExportHTmo(id_element) {
            ...
            function prdf() {
                ...
                if(qte && produit) {
                    $.ajax({
                        type: "POST",
                        url: "produitinfoHT.php?produit=" + produit + "&qte=" + qte,
                        success: function (data) {
                            calculExportHT();
                            $("#prdl").append(data);
                        }
...
<?php } ?>
                    ...
                    function removeProduct(id) {
                        if(id === undefined) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: "calculExportHT.php?productId="+id,
                                success: function (data) {
                                    document.getElementById("calculExportHT").innerHTML = data;
                                }
                            });
                ...
                function calculExportHTPrixtest3() {
                var ht = document.getElementById("productPriceTTC").value;
                var tva = document.getElementById("__BVID__1521").value;
                $.ajax({
                    type: "POST",
                    url: "calculExportHTprixht2.php",
                    data: {
                        ht: ht,
                        tva2: tva
                    },
        ...
        <script type="text/javascript">
         $(function () {
                $("#btnPrint").click(function () {
                    ...
                    frameDoc.document.write('<link href="<?php echo url ?>static/style.css" rel="stylesheet">');
                    frameDoc.document.write('<link href="<?php echo url ?>dist/style.css" rel="stylesheet">');
                    frameDoc.document.write('<link href="<?php echo url ?>static/factures.css" rel="stylesheet">');
                    frameDoc.document.write('<link href="<?php echo url ?>data.css" rel="stylesheet">');
                    // frameDoc.document.write('<link href="data.css" rel="stylesheet">');
                    frameDoc.document.write('<link rel="icon" type="image/png" sizes="32x32" href="<?php echo url ?>static/icon.png">');
                    frameDoc.document.write('<link href="https://unpkg.com/ionicons@4.5.1/dist/css/ionicons.min.css" rel="stylesheet">');
                    frameDoc.document.write('<link href="<?php echo url ?>static/dev.css" rel="stylesheet">');
                    ...
                    frameDoc.document.write('<link rel="stylesheet" href="dist/css/styles.css">');

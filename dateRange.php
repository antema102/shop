...
// indexes
$dev = mysqli_fetch_all(mysqli_query($link, "SELECT * FROM `devis`"));
$newarray=array();
$cond='(';
...
foreach ($dev as $item){
    ...
    if (strtotime($item[9]) >=strtotime($start_date)  &&
        strtotime($item[9]) <=strtotime($end_date) ){
                    ...
                    <div class="modal-body">
                        ...
                        <div data-v-9af19398="" class="col-12">
                            <div data-v-9af19398="" class="buttons-list">
                                ...
                                <div class="btn btn-default waiting" onclick="etat(0,' . $d . ')"><i class="icon ion-md-checkmark shown" ></i>
                                    En attente
                                </div>
                                <div class="btn btn-default accepted" onclick="etat(1,' . $d . ')"><i class="icon ion-md-checkmark shown"></i>
                                    Accepté
                                </div>
                                <div class="btn btn-default invoiced" onclick="etat(2,' . $d . ')"><i class="icon ion-md-checkmark shown"></i>
                                    Facturé
                                </div>
                                <div class="btn btn-default refused" onclick="etat(3,' . $d . ')"><i class="icon ion-md-checkmark shown"></i>
                                    Refusé
                                </div>
...
//                                </div>-->
        ...
        if ($fac['etat'] == 2) {
            return '<i class="fas fa-circle" style="color:#009393 ;margin-right:12px;cursor: pointer;"data-bs-toggle="modal" data-bs-target="#notif"></i>  <div class="modal fade" id="notif" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog">
        <div role="document" class="modal-content" >
            <div class="modal-body" id="__BVID__267___BV_modal_body_">
                <div class="btn btn-default refused" style="margin-top: 20px;" ><i class="fas fa-times"></i>
                    vous ne pouvez pas changer la statut de ce devis car il est deja facturé
                </div>
            </div>
        </div>
    </div>
...
';
        ...
        if ($fac['etat'] == 3) {
            return '<i class="fas fa-circle" style="color:#E84C77 ;margin-right:12px;cursor: pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal_' . $d . '"></i>
               <div class="modal fade" id="exampleModal_' . $d . '" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <div class="modal-dialog">
        <div role="document" class="modal-content" >
          <div class="modal-header">
            ...
            <div class="modal-body" id="__BVID__267___BV_modal_body_">
                <div class="btn btn-default refused" style="margin-top: 20px;" ><i class="fas fa-times"></i>
                    vous ne pouvez pas changer la statut de ce devis car il est déjà annulé
                </div>
            </div>
        </div>
    </div>

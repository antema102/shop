                            ...
                            <div data-v-561bb412="" class="quote-header">
                                <div data-v-561bb412="" >
                                    <div data-v-561bb412="" class="logo-wrapper" style="height: 100px; margin: 20px;">
                                        <img data-v-561bb412="" loading="lazy" src="<?php echo url ?>img/logo.jpg" alt="" class="logo">
                                    </div>
                                </div>
                                <div data-v-561bb412="">
                                    ...
                                    <div data-v-248579a2="" class="document_summary" id="calcul">
                                        <table data-v-248579a2="">
                                            <tbody data-v-248579a2="">
                                                <tr data-v-248579a2="" style="background-color: #BBC641 ; color: rgb(255, 255, 255);">
...
<!--                                                --><?php //}?>
                                        ...
                                        <?php if ($facture['remise'] > 0 && $facture['netpayer'] > 0) { ?>
                                            ...
                                            <table data-v-248579a2="">
                                                <tbody data-v-248579a2="">
                                                <tr data-v-248579a2=""
                                                    style="background-color: #BBC641 ;  color: rgb(255, 255, 255);">

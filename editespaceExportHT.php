...
$obj=mysqli_query($link, "SELECT * FROM `detail_espace` WHERE `id_devis` ='" . $facture['id'] . "'");
...
<html lang="fr" >
    ...
    <body lang="fr">
        <div class="LayoutShell">
            ...
            <main class="main">
                <form method="post" action="edit_esp.php">
                        ...
                        <div data-v-561bb412="" class="menu-bar fab" style="left:90px">
                            <div data-v-561bb412="" class="center" style="margin-left:200px;margin-right: 200px;height:58px ; width: 950px;">
                                <div data-v-561bb412="" class="float-right">
                                    <input type="hidden" name="iddev" value="<?php echo $facture['id'] ?>">
                                            ...
                                            <table data-v-248579a2="">
                                                <tbody data-v-248579a2="">
                                                    ...
                                                    <tr data-v-248579a2="">
                                                        ...
                                                        <td data-v-248579a2="" role="totalHT" class="r-number"><?php echo $facture['prix_ht'] ?></td>
                                                    </tr>
                                                    <tr data-v-248579a2=""style="display: inline-table ; display: none;" >
                                                        <td data-v-248579a2="">Montant total TVA</td>
                                                        <td data-v-248579a2="" role="totalTVA" class="r-number"><?php echo $facture['tva'] ?></td>
                                                    </tr>
                                                    <tr data-v-248579a2="" class="total" style="display: inline-table ; display: none;">
                                                        <td data-v-248579a2="">Montant total TTC</td>
                                                        <td data-v-248579a2="" role="total_ttc" class="r-number"><?php echo $facture['prix_ttc'] ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <div data-v-561bb412="" class="editable inline-block shipping-block" data-bs-toggle="modal" data-bs-target="#modalinfoliv">
                                        ...
                                        <div id="infol">
                                            ...
                                            <div data-v-02611d7b="" data-v-561bb412="" class="invoice_payment">
                                                ...
                                                <div data-v-02611d7b="" class="payment-mode">Aderesse de livraison :  <?php echo $facture['adr'] ?> </div>
                    ...
                    success: function (data) {
                        document.getElementById("calcul").innerHTML = data;
                                                    ...
                                                    function devinfo() {
                                                        ...
                                                        $.ajax({
                                                            type: "POST",
                                                            url:  "infodepaiment.php?datep=" + datep + "&numb=" + numb + "&espece=" + espece,
                                                            success: function (data) {
...
<?php } ?>
            ...
            function removeProduct(id) {
               espaceId =document.getElementById('pr-'+id).dataset.detail;
                ...
                $.ajax({
                    type: "POST",
                    url: "deleteDetailDevis.php?detail="+espaceId,
                    success: function (data) {

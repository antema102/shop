...
/* $devis = mysqli_fetch_all(mysqli_query($link, "SELECT * FROM `devis` "));
var_dump($devis);
var_dump (sizeof($devis));
  foreach($devis as $field) {
var_dump ($field[0]);
}
*/
...
{
$_SESSION['cart'] = array();
$devis = mysqli_query($link, "SELECT `num` FROM `devis` ");
var_dump($devis);
var_dump (sizeof($devis));
// for ($i = 0; $i < sizeof($devis); $i++) {
while ($row = mysqli_fetch_assoc($devis)) {

var_dump ('salut');
$details_devis = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `detail_devis` WHERE  `num` =" . $devis['num']));
var_dump($details_devis);
for ($j = 0; $j < sizeof($details_devis); $j++) {

$prod_val = explode(',', $details_devis['id_prod'] );
$id_prod = $prod_val[0];
$qte = $prod_val[1];
$produit = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `produit` WHERE  `num` =" . $id_prod));


$objet_devis = array("idDevis" => $devis['num']);
$objet = array("id" => $produit['id'], "nom" => (string) $produit['nom'],"prix_ht" => (string) $montantht, "qte" => (string) $qte, "prix_ttc" => (string) $prix_ttc);

array_push($objet_devis, $objet);
array_push($_SESSION['cart'], $objet_devis);
var_dump($objet_devis);
            ...
            <div class="row">
                <div class="col-12">
                    <div class="menu-tabs mt-4">
                        ...
                        <a class="tab active" >Devis</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-12" style="text-align:center;" id="notf"></div>
        <div data-v-9af19398="" id="content-wrapper" class="container-xxl">
            <div data-v-9af19398="" class="row row_header mb-5">
                <div data-v-9af19398="" class="col-xl-3 col-md-6 ">
                    <h1 data-v-9af19398="" class="title header-form">Liste des devis</h1>
                </div>
                <div data-v-9af19398="" class="col-xl-6 col-md-6 d-flex justify-content-center">
                    <form data-v-9af19398="" class="search-zone form-inline">
                        <input data-v-9af19398="" type="text" placeholder="Rechercher un devis" class="inline search form-control form-control" id=""> <!---->
                            ...
                            <div data-v-6a7eb354="" class="col-md-8 d-flex justify-content-end">
                                <div data-v-5232cd18="" data-v-9af19398="" class="actions sub-menu quote">
                                    <div data-v-5232cd18="" class="dropdown-item">
                                        <a data-v-5232cd18="" href="adddevis.php" class="w_actions_button has-tooltip" data-original-title="null">
                                            <i data-v-5232cd18="" style="color:#ffffff;" class="icon ion-ios-add"></i>
                                            <span data-v-5232cd18="" style="color:#ffffff;">Créer un devis</span></a>
                                    </div>
    ...
    <div style="font-weight :600" > Du </div>
                ...
                <div class="col-md-3">
                    <div class="input-group mb-3">
                        ...
                        <input type="date" class="form-control" id="start_date" placeholder="Start Date"  style="
    ...
    <div style="font-weight :600"> Au </div>
                ...
                <div class="col-md-3">
                    <div class="input-group mb-3">
                        ...
                        <input type="date" class="form-control" id="end_date" placeholder="End Date"  style="
    color: #28B5BF;font-weight :600" >
                    </div>
                </div>
            ...
            <div data-v-9af19398="" class="row middle mb-2">
                <div data-v-9af19398="" class="col-12">
                    <div data-v-9af19398="" class="buttons-list">
                        ...
                        <div class="btn btn-default invoiced" onclick="f2()"><i class="icon ion-md-checkmark shown"></i>
                            Facturé
                        </div>
                        <div class="btn btn-default refused" onclick="f3()"><i class="icon ion-md-checkmark shown"></i>
                            Refusé
                        </div>
                        <div class="btn btn-default canceled" onclick="f4()" ><i class="icon ion-md-checkmark shown"></i>
                            Annulé
                        </div>
                        <!--                                <div class="btn btn-default unchecked draft"><i class="icon ion-md-checkmark"></i>-->
                        <!--                                    Brouillon-->
                        <!--                                </div>-->
                        <!--                                <div class="btn btn-default draft" onclick="f5()" ><i class="icon ion-md-checkmark shown"></i>-->
                        <!--                                    Retard-->
                        <!--                                </div>-->
            ...
            <div class="row ">
                <div class="col-md-12">
                    ...
                    <div data-v-9af19398="" class="row mt-3">
                        <div data-v-9af19398="" class="col-12" >
                            <div data-v-9af19398="" class="card table-wrap mb-3" >
                                ...
                                <div style="display: none;" id="e0">
                                    <table data-v-9af19398="" role="table" aria-busy="false" aria-colcount="8" class="table b-table fixed-table responsive-table mb-0 table-hover b-table-stacked-md" id="__BVID__92e0" >
                                        <thead class="">
                                        <th style="width:200px !important;">Numéro</th>
                                        <th style="width:235px !important;">Client</th>
                                        <th  style="width:140px !important;">Type</th>
                                        <th style="width:158px !important;">Date</th>
                                        <th style="width:200px !important;">Total TTC</th>
                                        <th style="width:100px !important;">Statut</th>
                                        </thead>
...
<script src="https://cdn.datatables.net/plug-ins/1.10.20/pagination/four_button.js" ></script>
...
<script>
    $(document).ready(function () {
        ...
        //toTable = $('#__BVID__92').DataTable({
        //    "pageLength": 50,
        //    "processing": false,
        //    "serverSide": true,
        //    "ajax": "<?php //echo url ?>//finded.php",
        //    "dom": 'Bfrtip',
        //    "order": [[1, "asc"]], //or asc,
        //    buttons: [
        //        {
        ...
        //});
        //var today = new Date();
        //var date = today.getFullYear()+'-'+(today.getMonth()+1)+'-'+0+today.getDate();console.log('hello',date)
        var offset = new Date().getTimezoneOffset();
        var today = new Date(new Date().getTime() - (offset*60*1000));
        var date = today.toISOString().split('T')[0];
        $("#start_date").val(date)// empty value
         $("#end_date").val(date)
            toTable = $('#__BVID__92').DataTable({
                "pageLength": 50,
                "processing": false,
                "serverSide": true,
                "ajax": "<?php echo url ?>dateRange.php?start_date="+date+"&end_date="+date+"",
                "dom": 'Bfrtip',
                "order": [[1, "asc"]], //or asc,
                buttons: [
                    {
    ...
    //     {
    //         var dataTable = $('#__BVID__92').DataTable({
    //             "processing" : true,
    //             "serverSide" : true,
    //             "order" : [],
    //             "ajax" : {
    ...
    $(document).on("click", "#filter", function(e) {
        ...
        if (start_date == "" || end_date == "") {
            ...
            toTable = $('#__BVID__92').DataTable({
                ...
                "processing": false,
                "serverSide": true,
                "ajax": "<?php echo url ?>dateRange.php?start_date="+start_date+"&end_date="+end_date+"",
                "dom": 'Bfrtip',
                "order": [[1, "asc"]], //or asc,
                buttons: [
                    {
...
<script>
    ...
    function etat(etat, id) {
        $.ajax({
            type: "POST",
            url: "edit_status_dev.php?etat=" + etat + "&id=" + id,
    ...
    function not() {
        $.ajax({
            url: "notif.php",
            success: function (o) {
                document.getElementById("notf").innerHTML = o;
            }
        })
...
<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#__BVID__92e0').DataTable({
            ...
            "processing": false,
            "serverSide": true,
            "ajax": "<?php echo url ?>findede0.php",
            "dom": 'Bfrtip',
            "order": [[1, "asc"]], //or asc,
            buttons: [
                {
    ...
    $(document).ready(function () {
        ...
        oTable = $('#__BVID__92e1').DataTable({
            ...
            "processing": false,
            "serverSide": true,
            "ajax": "<?php echo url ?>findede1.php",
            "dom": 'Bfrtip',
            "order": [[1, "asc"]], //or asc,
            buttons: [
                {
    ...
    $(document).ready(function () {
        ...
        oTable = $('#__BVID__92e2').DataTable({
            ...
            "processing": false,
            "serverSide": true,
            "ajax": "<?php echo url ?>findede2.php",
            "dom": 'Bfrtip',
            "order": [[1, "asc"]], //or asc,
            buttons: [
                {
    ...
    $(document).ready(function () {
        ...
        oTable = $('#__BVID__92e3').DataTable({
            ...
            "processing": false,
            "serverSide": true,
            "ajax": "<?php echo url ?>findede3.php",
            "dom": 'Bfrtip',
            "order": [[1, "asc"]], //or asc,
            buttons: [
                {
    ...
    $(document).ready(function () {
        ...
        oTable = $('#__BVID__92e4').DataTable({
            ...
            "processing": false,
            "serverSide": true,
            "ajax": "<?php echo url ?>findede4.php",
            "dom": 'Bfrtip',
            "order": [[1, "asc"]], //or asc,
            buttons: [
                {
    ...
    $(document).ready(function () {
        ...
        oTable = $('#__BVID__92e5').DataTable({
            ...
            "processing": false,
            "serverSide": true,
            "ajax": "<?php echo url ?>findede5.php",
            "dom": 'Bfrtip',
            "order": [[1, "asc"]], //or asc,
            buttons: [
                {

...
<html lang="fr" > 
    <head>
        ...
        <title>Facture - <?php echo $facture['num'] ?> </title>
                ...
                <div data-v-561bb412="" size="A4" style="height: auto;" data-id="1" class="page narrow top-shadow bottom-shadow">
                    ...
                    <div data-v-561bb412="" class="content">
                                    ...
                                    <?php
                                        ...
                                        $client_value = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `client` WHERE `id` =" . $avoir_value['client'] . ""));
                                          ?>
                                            ...
                                            <tr data-v-561bb412="" id="<?php echo $idAvoir ?>" class="line editable grabbable visible" onclick="deltr()" draggable="false" style="">
                                                ...
                                                <td data-v-561bb412="" style="padding-top: 19px;background-color: #e9ecef;" class="r-number no-wrap price_ht">
                        ...
                        <div data-v-dc3a3862="" data-v-561bb412="" class="company-footer"
                            ...
                            <span data-v-dc3a3862="" class="align-center"> BLOOMS DECOR - 209 Avenue de la république 93800 Epinay sur seine France <br></span>
...
<script>
    function printDiv()
    {
        ...
        setTimeout(function () {
            window.location.replace("http://shop-bloomsdecor.eu/facture.php");
        }, 10);

...
<html lang="fr" > 
    <head>
        ...
        <title>Facture HT - <?php echo $facture['num'] ?> </title>
                            ...
                            <div data-v-561bb412="">
                                <div data-v-561bb412="" class="row address-informations">
                                    <div data-v-561bb412="" class="company-infos col">
                                        ...
                                        <div data-v-561bb412="" class="company-name">Bloomsdecor</div>
                            ...
                            <table data-v-561bb412="" class="quote-lines-table">
                                <thead data-v-561bb412="" class="quote-lines-header">
                                    <tr data-v-561bb412="" style="background-color: #BBC641; color: rgb(255, 255, 255);">
                                        ...
                                        <th data-v-561bb412="" class="text--right text--nowrap" style="display: none;">
                                ...
                                <tbody data-v-561bb412=""  class="table__body table__body--empty">
                                    ...
                                    while ($facture_detail = mysqli_fetch_array($facture_detail_sql)) {
                                        ...
                                        <tr data-v-561bb412="" id="<?php echo $produit['id'] ?>" class="line editable grabbable visible" onclick="deltr()" draggable="false" style="">
                                            ...
                                            <td data-v-561bb412="" class="r-number no-wrap discount" style="display: none;">
                                                <span data-v-561bb412="">
                                            ...
                                            <td data-v-561bb412="" class="quantity" style="display: none;">
                                                <?php
                                ...
                                <div data-v-248579a2="" class="document_summary" id="calcul">
                                    <table data-v-248579a2="">
                                        ...
                                        <tr data-v-248579a2="">
                                                ...
                                                <tr data-v-248579a2="" class="total">
                                                    ...
                                                    <td data-v-248579a2="" role="total_ht" class="r-number">
                                                        <?php
                                                        $facVal = $facture['prix_ht'];
                                                        if($facture['frais_liv']!==''){
                                                            $facVal = $facture['prix_ht'] + $facture['frais_liv'];
                                                        }
                                                        $pontee = strpos($facVal, ".");
                                                        if ($pontee > 0) {
                                                            echo number_format($facVal, 2, ".", " ");
                                                        } else {
                                                            echo number_format($facVal, 2, ",", " ");
                                                        }
                                                        ?> €</td>
                                            ...
                                            <tr data-v-248579a2="" class="total" style="display: none;">
                                    ...
                                    <table data-v-248579a2="">
                                            ...
                                            <tr data-v-248579a2="">
											  ...
											  <tr data-v-248579a2="">
                                                    <td data-v-248579a2="">Montant Total HT </td>
                                                    <td data-v-248579a2="" role="" class="r-number">
                                                    <?php
                                                        $facVal1 = $facture['prix_ht'];
                                                        if($facture['frais_liv']!==''){
                                                            $facVal1 = $facture['prix_ht'] + $facture['frais_liv'];
                                                        }
                                                        $pontee = strpos($facVal1, ".");
                                                        if ($pontee > 0) {
                                                            echo number_format($facVal1, 2, ".", " ");
                                                        } else {
                                                            echo number_format($facVal1, 2, ",", " ");
                                                        }
                                                        ?> €</td>
                                                    ...
                                                    <td data-v-248579a2="" role="totalremise" class="r-number">
                                                        <?php
                                                        $pontee = strpos($facture['remise_globale'], ".");
                                                        if ($pontee > 0) {
                                                            echo number_format($facture['remise_globale'], 2, ".", " ");
                                                        } else {
                                                            echo number_format($facture['remise_globale'], 2, ",", " ");
                                                        }
                                                        ?> €
...
<!--                                        </div>-->
                        ...
                        <div data-v-dc3a3862="" data-v-561bb412="" class="company-footer"
                            ...
                            <span data-v-dc3a3862="" class="align-center"> BloomsDecor - Blooms DECOR, 209 Avenue de la république 93800 Epinay sur seine France <br></span>

...
$columns = array(
    ...
    array('db' => 'id', 'dt' => 5, 'formatter' => function($d, $row) {
            ...
            return '<i class="fas fa-circle" style="color:#3D7DA0 ;margin-right:12px;cursor: pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal0_' . $d . '"></i>
               <div class="modal fade" id="exampleModal0_' . $d . '" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div data-v-9af19398="" class="col-12">
                            <div data-v-9af19398="" class="buttons-list">
                                ...
                                <div class="btn btn-default canceled" style="border: 2px solid #F29C9E !important; color:#F29C9E !important;background:#961316 !important;" onclick="etat(5,' . $d . ')"><i class="icon ion-md-checkmark shown"></i>
                                    Annuler
                                </div>
...
echo json_encode(
        SSP::complex22($_GET, $sql_details, $table, $primaryKey, $columns, null, "etat = '0'")
);
?>
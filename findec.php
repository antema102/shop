...
$columns = array(
    array('db' => 'mob', 'dt' => 0),
    array('db' => 'id', 'dt' => 0, 'formatter' => function ($d, $row) use ($link) {
...
<div class="modal fade" id="exampleModal_' . $d . '" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    array('db' => 'id', 'dt' => 1, 'formatter' => function ($d, $row) use ($url, $link) {
    ...
    array('db' => 'id', 'dt' => 2, 'formatter' => function ($d, $row) use ($link) {
        $tab = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `client` WHERE id=" . $d . ""));
        return
            '<div>
                                                <div data-v-143dd668="" class="phones flex direction">
                                                    ...
                                                    <div data-v-143dd668="" class="flex center w-auto">
                                                     ...
                                                     <div data-v-143dd668="" class="flex center w-auto" style="">
    ...
    array('db' => 'id', 'dt' => 3, 'formatter' => function ($d, $row) use ($url, $link) {
        ...
        if ($tab['etiquet'] == 0) {
            ...
            return
                ...
                '<div>   <a href="' . $url . 'detail_client.php?id=' . $d . '" >
                            <div data-v-143dd668="" class="clickable-tags">
                                <div  class="tag badge permanent" style="background:#F2D600" ;padding:4px !important;margin-bottom: 2px; ">
            ...
            return
                ...
                '<div>   <a href="' . $url . 'detail_client.php?id=' . $d . '" >
                            <div data-v-143dd668="" class="clickable-tags">
                                <div  class="tag badge permanent" style="background:#5DADE2" ;padding:4px !important;margin-bottom: 2px; ">
                                    Fournisseur
                                </div>
...
if ($user2['role'] == 1) {
    ...
    echo json_encode(
        ...
        SSP::simple2($_GET, $sql_details, $table, $primaryKey, $columns)
    );

} else {
    echo json_encode(
        SSP::complex($_GET, $sql_details, $table, $primaryKey, $columns, null, "etiquet != '3'")
    );
}

...
//var_dump($facture['frais_liv'],$facture['tva_liv']);die();
$client = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `client` WHERE `id` =" . $facture['id']));
$_SESSION['cart'] = array();
$_SESSION['deletedProd'] = array();
//echo '<pre/>';
//if ($facture['frais_liv']!==''||$facture['frais_liv']!=='0'||$facture['frais_liv']!==0){
//    echo 'hello';die();
//}
//var_dump($facture['frais_liv']);die();
?>
<html lang="fr">
<head>
    <meta charset="utf-8">
...
<path d="m211 392h90c8.284 0 15-6.716 15-15s-6.716-15-15-15h-90c-8.284 0-15 6.716-15 15s6.716 15 15 15zm210-150c-8.284 0-15 6.716-15 15s6.716 15 15 15 15-6.716 15-15-6.716-15-15-15zm-210 210h90c8.284 0 15-6.716 15-15s-6.716-15-15-15h-90c-8.284 0-15 6.716-15 15s6.716 15 15 15zm240-300h-75v-77c0-41.355-33.645-75-75-75h-150c-8.284 0-15 6.716-15 15v137h-75c-24.813 0-45 20.187-45 45v150c0 24.813 20.187 45 45 45h75v105c0 8.284 6.716 15 15 15h210c8.284 0 15-6.716 15-15v-105h75c24.813 0 45-20.187 45-45v-150c0-24.813-20.187-45-45-45zm-106.939-90.061c-4.136-1.257-8.52-1.939-13.061-1.939h-15v-15c0-4.541-.682-8.925-1.939-13.061 14.327 4.354 25.646 15.674 30 30zm-178.061-31.939h105c8.271 0 15 6.729 15 15v30c0 8.284 6.716 15 15 15h30c8.271 0 15 6.729 15 15v47h-180zm180 452h-180v-150h180zm120-135c0 8.271-6.729 15-15 15h-75v-30h15c8.284 0 15-6.716 15-15s-6.716-15-15-15h-270c-8.284 0-15 6.716-15 15s6.716 15 15 15h15v30h-75c-8.271 0-15-6.729-15-15v-150c0-8.271 6.729-15 15-15h390c8.271 0 15 6.729 15 15zm-105-105c-8.284 0-15 6.716-15 15s6.716 15 15 15 15-6.716 15-15-6.716-15-15-15z" fill="url(#SVGID_1_)" data-original="url(#SVGID_1_)" ></path></g></g></g></g>
</svg>
                        </a>
                    </div>
                    ...
                    <div data-v-561bb412="" class="quote-header">
                        <div data-v-561bb412="">
                            <div data-v-561bb412="" class="logo-wrapper" style="height: 100px; margin: 20px;">
                                <img data-v-561bb412="" loading="lazy" src="<?php echo url ?>static/logo-ilo.png" alt=""
                        ...
                        <div data-v-561bb412="">
                            <div data-v-561bb412="" class="row address-informations">
                                ...
                                <div data-v-561bb412="" id="client" class="client-infos inline-block col colR"
                                     data-bs-toggle="modal" data-bs-target="#modalinfoc">
                                    <!--                                            <span data-v-561bb412="">-->
                                    <!--                                                <div data-v-561bb412="" class="grey-title">Adresse de client: -->
                                    <?php //echo $client['adr'] ?><!--</div> -->
                                    <!--                                                <input type="hidden" value="-->
                                    <?php //echo $client['id'] ?><!--" name="clientd">-->
                                    <!---->
                                    <!--                                                <div data-v-561bb412="" class="client_name">Nom de client: </div> -->
                                    <!--                                                <div data-v-561bb412="" class="contact_contact">-->
                                    <!--                                                    <span data-v-561bb412=""> -->
                                    <?php //echo $client['civ'] ?><!--</span>-->
                                    <!--                                                    -->
                                    <?php //echo $client['nom'] ?><!-- --><?php //echo $client['prenom'] ?>
                                    <!--                                                </div> -->
                                    <!---->
                                    <!--                                                <div data-v-561bb412="" class="client_city">-->
                                    <?php //echo $client['pays'] ?><!-- --><?php //echo $client['ville'] ?><!-- -->
                                    <?php //echo $client['cp'] ?><!--</div> -->
                                    <!--                                                <div data-v-561bb412="" class="contact_phone">-->
                                    <?php //echo $client['tel'] ?><!--</div> -->
                                    <!--                                                <div data-v-561bb412="" class="contact_email">-->
                                    <?php //echo $client['email'] ?><!--</div>-->
                                    <!--                                            </span>-->
                                    <span data-v-561bb412="">
                                                ...
                                                <div data-v-561bb412=""
                                                     class="client_city"> <?php echo $client['adr'] ?> <br> <?php echo $client['cp'] ?> <?php echo $client['ville'] ?> <?php echo $client['pays'] ?>  </div>
                                                <div data-v-561bb412=""
                                                     class="contact_phone"><?php echo $client['tel'] ?></div>
                                                <div data-v-561bb412=""
                                                     class="contact_email" id="contact_email"><?php echo $client['email'] ?></div>
                                            </span>
                    ...
                    <div data-v-561bb412="" class="quote-lines padT" id="cnt">
                        ...
                        <table data-v-561bb412="" class="quote-lines-table">
                            ...
                            while ($facture_detail = mysqli_fetch_array($facture_detail_sql)) {
                                ...
                                <tr data-v-561bb412="" id="<?php echo $produit['id'] ?>"
                                    class="line editable grabbable bodyC visible" onclick="deltr()" draggable="false">
                            ...
                            <h6 data-v-561bb412="" class="not-visible " > Informations de livraison</h6>
                                <div id="" class="">
                                    ...
                                    <div data-v-02611d7b="" data-v-561bb412="" class="invoice_payment">
                                        ...
                                        <?php if ((integer) $facture['frais_liv']>0 && $facture['frais_liv']!=='') { ?>
                                            <div data-v-02611d7b="" class="payment-mode">Frais de livraison : <?php echo $facture['frais_liv'] ?> €
                                            </div>
                                            <div data-v-02611d7b="" class="payment-mode" style="display: inline-table ; display: none;">TVA de livraison 
                                            <?php
                                                if((float)$tvaVal>0){
                                                    echo $tvaVal;
                                                }else{
                                                ...
                                                ?>%
                                                : <?php if( (float)$facture['tva_liv']>0){
                                        ...
                                        <?php } ?>
                                        <div data-v-02611d7b="" class="payment-mode">Adresse de livraison
                                            : <?php echo $facture['adr'] ?> </div>
                                        <div data-v-02611d7b="" class="payment-mode">Code postal
                                            : <?php echo $facture['cp'] ?></div>
                                        <div data-v-02611d7b="" class="payment-mode">Ville
                                            : <?php echo $facture['ville'] ?> </div>
                                        <div data-v-02611d7b="" class="payment-mode">Pays
                                            : <?php echo $facture['pays'] ?> </div>
                                ...
                                <table data-v-248579a2="">
                                    ...
                                    if ((float) $facture['frais_liv'] >0 && $facture['frais_liv']!=='') {
                                        ...
                                        <tr data-v-248579a2="" style="display: none;">
                                            ...
                                            <td data-v-248579a2="" role="" class="r-number" id="" onchange="">
                                                ...
                                                echo number_format((float)$facture['tva_liv'], 2, ".", " ");
                                    ...
                                    <tr data-v-248579a2="">
                                        ...
                                        <td data-v-248579a2="" role="totalHT" class="r-number">
                                            ...
                                            if ($pontee > 0) {
                                                echo number_format((float)$facture['prix_ht'], 2, ".", " ");
                                            } else {
                                                echo number_format((float)$facture['prix_ht'], 2, ",", " ");
                                            }
                                            ?> €
                                    ...
                                    <tr data-v-248579a2="">
                                        ...
                                        <td data-v-248579a2="" role="totalTVA" class="r-number">
                                            ...
                                            if ($pontee > 0) {
                                                echo number_format((float)$facture['tva'], 2, ".", " ");
                                            } else {
                                                echo number_format((float)$facture['tva'], 2, ",", " ");
                                            }
                                            ?> €
                                    ...
                                    <tr data-v-248579a2="" class="total">
                                        ...
                                        <td data-v-248579a2="" role="total_ttc" class="r-number">
                                            ...
                                            if ($pontee > 0) {
                                                echo number_format((float)$facture['prix_ttc'], 2, ".", " ");
                                            } else {
                                                echo number_format((float)$facture['prix_ttc'], 2, ",", " ");
                                            }
                                            ?> €
...
<!--                                        </tr>-->
                      ...
                      <!--  <div class="row">
                            <div data-v-561bb412="" class="shipping-block ">
                            <h6 data-v-561bb412="" class="not-visible " style=""> Informations de livraison</h6>
                                <div id="" class="">
                        ...
                        <div data-v-561bb412="" class="quote-footer">
                            <div id="comm">
                                ...
                                <div data-v-561bb412="" class="quote-notes" data-bs-toggle="modal"
                                     data-bs-target="#modalinfocomm">
                    ...
                    <div data-v-dc3a3862="" data-v-561bb412="" class="company-footer"
                        ...
                        <span data-v-dc3a3862=""
                              class="align-center">Pour toute assistance, merci de nous contacter :<br></span>

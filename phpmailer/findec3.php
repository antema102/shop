...
<div class="modal fade" id="exampleModal_' . $d . '" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    array('db' => 'id', 'dt' => 1, 'formatter' => function($d, $row) {
        include 'db.php';
        $tab1 = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `client` WHERE id=" . $d . " and etiquet='3' "));
        if ($tab['etiquet'] == 3) {
            return
    ...
    array('db' => 'id', 'dt' => 3, 'formatter' => function($d, $row) {
        ...
        $tab = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `client` WHERE id=" . $d . " and etiquet='3' "));
        if ($tab['etiquet'] == 0) {

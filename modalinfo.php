            ...
            <div class="modal-body" id="__BVID__41___BV_modal_body_">
                <div data-v-33681578="" data-v-561bb412="">
                    <div data-v-33681578="" class="modal-in">
                        <div data-v-33681578="" class="section-2">
                            <div data-v-33681578="" id="titleLbl" role="group"
                                 aria-labelledby="titleLbl__BV_label_"
                                 aria-describedby="titleLbl__BV_description_" class="form-group">
                                <label id="titleLbl__BV_label_" for="documentTitle" class="d-block">Titre du document</label>
                                <div>
                                    <input data-v-33681578=""  type="text" placeholder="Titre du document" id="titlec" class="form-control" >
                                    <small tabindex="-1" id="titleLbl__BV_description_" class="form-text text-muted">Quelques mots pour décrire l'objet du document</small> 
                                </div>
                            </div>
                    ...
                    <footer data-v-33681578="" class="modal-footer fixed">
                        ...
                        <button data-v-33681578="" type="button" onclick="titref()" class="btn btn btn-default btn-primary btn-secondary" data-bs-dismiss="modal"  aria-label="Close">Enregistrer
                        </button>
                    </footer>
                </div>
            </div>

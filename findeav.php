...
// indexes
$dev = mysqli_fetch_all(mysqli_query($link, "SELECT * FROM `avoir`"));
...
$columns = array(
    array('db' => 'id', 'dt' => 0, 'formatter' => function($d, $row) {
            include 'db.php';
            $requete1=$link->query("SELECT * FROM `avoir` WHERE id=" . $d . "");
            $dev=$requete1->fetch_assoc();
    ...
    array('db' => 'id', 'dt' => 1, 'formatter' => function($d, $row) {
            ...
            include 'db.php';
            $dev = mysqli_fetch_array(mysqli_query($link, "SELECT * FROM `avoir` WHERE id=" . $d . ""));
            //$requete2=$link->query("SELECT * FROM `client` WHERE id=" . $dev['client'] . "");

...
//            return '' . $ver . ' ' . $ch . ' ' . $cb . ' ';
    ...
    array('db' => 'id', 'dt' => 5, 'formatter' => function($d, $row) {
            ...
            if ($fac['etat'] == 1) {
                return '<i class="fas fa-circle" style="color:#28B5BF ;margin-right:12px;cursor: pointer;" data-bs-toggle="modal" data-bs-target="#exampleModal1_' . $d . '"></i>
               <div class="modal fade" id="exampleModal1_' . $d . '" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
echo json_encode(
        SSP::complex22($_GET, $sql_details, $table, $primaryKey, $columns, null, "etat = '1'")
);
?>